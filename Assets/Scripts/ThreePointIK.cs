...
public class ThreePointIK : MonoBehaviour {
	...
	public void UpdateIK()
	{
        ...
        switch (bendNormalStrategy)
        {
            case BendNormalStrategy.followTarget:
			    bendNormal = - Vector3.Cross (actualTargetPos - bone1.trans.position, target.up);
                break;
	...
	void Init()
	{
        ...
        GameObject bone1_fix = new GameObject(IKBone1.gameObject.name+"_fix");
        bone1_fix.transform.position = IKBone1.position;
        bone1_fix.transform.parent = IKBone1.parent;
        IKBone1.parent = bone1_fix.transform;

        GameObject bone2_fix = new GameObject(IKBone2.gameObject.name + "_fix");
        bone2_fix.transform.position = IKBone2.position;
        bone2_fix.transform.parent = IKBone2.parent;
        IKBone2.parent = bone2_fix.transform;

        GameObject bone3_fix = new GameObject(IKBone3.gameObject.name + "_fix");
        bone3_fix.transform.position = IKBone3.position;
        bone3_fix.transform.parent = IKBone3.parent;
        IKBone3.parent = bone3_fix.transform;

        bone1 = new Bone{ trans = bone1_fix.transform };
		bone2 = new Bone{ trans = bone2_fix.transform };
		bone3 = new Bone{ trans = bone3_fix.transform };
